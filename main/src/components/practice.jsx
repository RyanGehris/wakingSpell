  ...
  return (
    <div className="practiceCont">
      ...
      <div className="practiceReqs">
        <span style={{ border: `solid ${req["0"] ? "green" : "red"} 3px` }}>
          {words[0]}
        </span>
        <span style={{ border: `solid ${req["1"] ? "green" : "red"} 3px` }}>
          {words[1]}
        </span>
        <span style={{ border: `solid ${req["2"] ? "green" : "red"} 3px` }}>
          {words[2]}
        </span>
      </div>
      {req["0"] && req["1"] && req["2"] && (
